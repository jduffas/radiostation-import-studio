...
# bande 300-3000 Hz (celle que l'analyse isole), « instrumental » = sinus 60 Hz hors bande.
# Segments : 0-5s instru / 5-20s voix / 20-24s instru / 24-32s voix.
ffmpeg -y -v error -f lavfi -i "sine=f=60:d=5[i1];anoisesrc=d=15:c=pink:a=0.7[v0];[v0]highpass=f=300,lowpass=f=3000,volume=2.0[v1];sine=f=60:d=4[i2];anoisesrc=d=8:c=pink:a=0.7[v2b];[v2b]highpass=f=300,lowpass=f=3000,volume=2.0[v2];[i1][v1][i2][v2]concat=n=4:v=0:a=1" -ar 44100 -ac 2 "$DIR/vocal-sim.wav"
